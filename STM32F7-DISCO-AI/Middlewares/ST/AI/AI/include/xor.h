...
#define AI_XOR_MODEL_NAME          "xor"

#define AI_XOR_IN_NUM       (1)
#define AI_XOR_IN_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL)
#define AI_XOR_IN_1_SIZE \
  (1 * 1 * 2)

#define AI_XOR_OUT_NUM      (1)
#define AI_XOR_OUT_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL)
#define AI_XOR_OUT_1_SIZE \
  (1 * 1 * 1)
 ...
 * @ref ai_xor_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_XOR_*
 * defines into file @ref xor.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
